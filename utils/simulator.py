...
def generateRandomDataset(num_simulation, dataset_name):
    ...
    attuator1 = np.round(np.random.uniform(0.1, 0.9, num_simulation), 3)
    attuator2 = np.round(np.random.uniform(0.1, 0.9, num_simulation), 3)
    attuator3 = np.round(np.random.uniform(0.1, 0.9, num_simulation), 3)
...
def main():
    ...
    # generateRandomDataset(100, 'datasets/new_dataset.txt')
    act = np.array([
        [.1, .1, .1],
        # [.2, .18, .2],
        # [.2, .2, .18]
